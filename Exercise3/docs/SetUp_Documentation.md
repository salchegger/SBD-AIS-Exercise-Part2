# Exercise 12 - Set Up Documentation without Answers

## Step 1: Start Docker and run `docker compose up -d`
![alt text](image.png)
- before that check via `docker ps` that no other containers are running
